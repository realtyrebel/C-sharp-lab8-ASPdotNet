...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="form-group row">
        <label for="txtDeposit" class="col-md-4">Withdraw Amount:</label>
        <div class="col-md-5">
            <asp:TextBox ID="txtWithdraw" CssClass="input form-control" runat="server"></asp:TextBox>
        </div>
        <div class="col-md-3">
            <asp:CompareValidator CssClass="error" ControlToValidate="txtWithdraw" Type="Currency" Operator="GreaterThan" ValueToCompare="0" Display="Dynamic" ErrorMessage="Must be greater than 0!" runat="server"></asp:CompareValidator>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-8">
            <asp:RadioButtonList ID="WithdrawFromAccount" runat="server" RepeatDirection="Vertical">
                <asp:ListItem Value="0">&nbsp; from Chequing Account</asp:ListItem>
                <asp:ListItem Value="1">&nbsp; from Savings Account</asp:ListItem>
            </asp:RadioButtonList>
        </div>
    </div>    
    ...
    <div class="form-group row">
        <div class="col-md-4">
            <asp:Button ID="btnSubmit" CssClass="btn btn-primary" OnClick="Submit_Page" runat="server" Text="Withdraw Funds" />
        </div>
        <div class="col-md-8">
